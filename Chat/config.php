...
$conf['trusted_ip'] = localhost:8080;       // For example "159.8.8.107"
 ...
 */
$conf['mysql_db'] = "darling";
$conf['mysql_user'] = "root";
$conf['mysql_pw'] = "";
$conf['mysql_host'] = "localhost:8080"; 
/**
 * Access to the comet server
 * Get access keys here https://comet-server.com/#price
 */
$conf['cometQL_dev_id'] = 2521;
$conf['cometQL_key'] = "d5MVfHKspUWMqQ3OMHFq9gcDbE4eHNwJHDYJLcsv6ueotiuKNVFHp1DrFzF9lKxB";
 ...
 */
$conf['URL_getUsersHash'] = 'C:\Server\data\htdocs\test\Chat\backend-example\chat_get_user_hash.php';
/**
 * URL to request information about users in json
 * Used only in getUsersInfo
 */
$conf['URL_getUsersInfo'] = 'C:\Server\data\htdocs\test\Chat\backend-example\chat_get_users.php'; 
